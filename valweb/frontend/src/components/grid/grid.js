            ...
            <div className="row d-flex justify-content-center">
                <div className="col-sm-4 col-md-4 col-lg-4">
                    <div className="card bg-dark text-white d-flex justify-content-center flex-column customOuterGrid ">
                        <img className="card-img customCardImg" src="https://www.washingtonpost.com/resizer/Zwr8hLzf4l5uXnhLnv6qR5P0UDI=/480x0/arc-anglerfish-washpost-prod-washpost.s3.amazonaws.com/public/O6V76772TE5KVLLC7ZNLPF4ZV4.jpg" alt="Card" />
                ...
                <div className="col-sm-4 col-md-4 col-lg-4">
                    <div className="card bg-dark text-white d-flex justify-content-center flex-column customOuterGrid ">
                        <img className="card-img customCardImg" src="https://i.ytimg.com/vi/PZu6QdAjmOU/maxresdefault.jpg" alt="Card" />
